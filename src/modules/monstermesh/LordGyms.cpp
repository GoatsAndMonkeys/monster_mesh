...
{
    // initBattlePokeFromBase wants a dex number (its base-stats table is
    // dex-indexed). Gen1Party / Gen1Pokemon store species as the SAV's
    // internal hex code (0x01-0xBE), and the engine's SAV-aware loader
    // will convert internal→dex before looking up base stats. Keep both
