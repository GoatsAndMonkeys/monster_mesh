...
typedef struct _objects_t {
    ...
    // MonsterMesh terminal — appended at end to avoid shifting EEZ index offsets
    lv_obj_t *tools_mm_terminal_button;
    lv_obj_t *tools_mm_terminal_label;
    lv_obj_t *top_mm_terminal_panel;
    lv_obj_t *top_mm_terminal_label;
    lv_obj_t *mm_terminal_panel;
    lv_obj_t *mm_terminal_output;
    lv_obj_t *mm_terminal_input;
} objects_t;
