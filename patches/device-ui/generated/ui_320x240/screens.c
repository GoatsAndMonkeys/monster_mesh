...
// Retro pixel fonts (cozette 13/20/26 patched into generated/ui_320x240/)
...
#endif
#ifndef MONSTERMESH_BRANCH
#define MONSTERMESH_BRANCH "unknown"
#endif
...
void create_screen_boot_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff88D048), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_arc_color(obj, lv_color_hex(0xff0F380F), LV_PART_INDICATOR | LV_STATE_DEFAULT);
            lv_obj_set_style_arc_width(obj, 8, LV_PART_INDICATOR | LV_STATE_DEFAULT);
            lv_obj_set_style_arc_color(obj, lv_color_hex(0xff88D048), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        {
            // MeshtasticUrl — repurposed as "MonsterMesh" title
            ...
            lv_obj_set_style_text_font(obj, &lv_font_cozette_20, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xff0f380f), LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        {
        ...
        {
            // FirmwareLabel — meshtastic version (small)
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_image_recolor(obj, lv_color_hex(0xff0f380f), LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_main_screen() {
    ...
    add_style_main_screen_style(obj);
    {
                ...
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xfffffff4), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                            lv_obj_set_style_image_recolor(obj, lv_color_hex(0xffC4E878), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_align(obj, LV_ALIGN_TOP_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_radius(obj, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff306230), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xfff4f4f0), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xfff4f4f0), LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_clear_flag(obj, LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SNAPPABLE);
                        }
                        {
                            // gpsPositionImage
                            lv_obj_t *obj = lv_img_create(parent_obj);
                ...
                }
                {
                    ...
                    lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_ON_FOCUS|LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_RIGHT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                }
                {
                    ...
                    lv_obj_set_style_pad_column(obj, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_clear_flag(obj, LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_ON_FOCUS|LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_style_align(obj, LV_ALIGN_TOP_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff404040), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_border_color(obj, lv_color_hex(0xff011689), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_border_width(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
...
#if 0  // MM terminal not on this branch yet
                                {
        ...
        }
        {
            ...
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_image_recolor(obj, lv_color_hex(0xffC4E878), LV_PART_MAIN | LV_STATE_DISABLED);
...
#if 0  // MM terminal not on this branch yet
        {
            // TopMMTerminalPanel
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.top_mm_terminal_panel = obj;
            lv_obj_set_pos(obj, LV_PCT(12), 0);
            lv_obj_set_size(obj, LV_PCT(80), LV_PCT(10));
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            ...
            lv_obj_set_style_align(obj, LV_ALIGN_TOP_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // TopMMTerminalLabel
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    objects.top_mm_terminal_label = obj;
                    lv_obj_set_pos(obj, 5, 0);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_label_set_long_mode(obj, LV_LABEL_LONG_SCROLL_CIRCULAR);
                    lv_label_set_text(obj, "MonsterMesh Terminal");
        ...
        }
        {
            ...
            lv_obj_set_style_layout(obj, LV_LAYOUT_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, 150, 30);
                    lv_dropdown_set_options(obj, _("GBC\nDMG\nPocket\nP. Red\nP. Blue\nDark\nLight"));
                    add_style_drop_down_style(obj);
                    lv_obj_set_style_align(obj, LV_ALIGN_TOP_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_color(obj, lv_color_hex(0xffe0e0e0), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_top(obj, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                }
                {
                    ...
                    lv_obj_set_style_border_color(obj, lv_color_hex(0xff808080), LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
                            lv_obj_set_style_border_width(obj, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_border_color(obj, lv_color_hex(0xff306230), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_image_recolor(obj, lv_color_hex(0xffC4E878), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_image_recolor_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_align(obj, LV_ALIGN_TOP_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_radius(obj, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
...
#if 0  // MM terminal not on this branch yet
        {
            // MMTerminalPanel — container for output + input
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.mm_terminal_panel = obj;
            lv_obj_set_pos(obj, LV_PCT(12), LV_PCT(10));
            lv_obj_set_size(obj, LV_PCT(88), LV_PCT(90));
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER);
            ...
            lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0F380F), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_layout(obj, LV_LAYOUT_FLEX, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_COLUMN, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // MMTerminalOutput — scrollable output area
                    lv_obj_t *obj = lv_obj_create(parent_obj);
                    objects.mm_terminal_output = obj;
                    lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                    lv_obj_set_style_min_height(obj, 160, LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                {
                    // MMTerminalInput — one-line input textarea
                    lv_obj_t *obj = lv_textarea_create(parent_obj);
                    objects.mm_terminal_input = obj;
                    lv_obj_set_size(obj, LV_PCT(100), 28);
                    lv_textarea_set_one_line(obj, true);
                    lv_textarea_set_placeholder_text(obj, "type command...");
                    lv_textarea_set_text(obj, "");
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff1A4C1A), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xff88D048), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_font(obj, &lv_font_cozette_13, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_color(obj, lv_color_hex(0xff5C9C3C), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_width(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_lock_screen() {
    ...
    add_style_main_screen_style(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_text_font(obj, &lv_font_cozette_13, LV_PART_ITEMS | LV_STATE_DEFAULT);
