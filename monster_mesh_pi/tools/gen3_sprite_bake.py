...
def main():
    ...
    total_front = write_header(
        ...
        "kGen3ColorPalettes", "kGen3ColorDeflate", "kGen3ColorDeflateOffsets",
        FRONT_W, FRONT_H,
        front_palettes, front_blobs,
        f"Gen3ColorIcons — {FRONT_W}x{FRONT_H} 4-color Gen-3 (Emerald/FRLG) front sprites")

    total_back = write_header(
        OUT_BACK,
        "GEN3_BACK_W", "GEN3_BACK_H",
        "kGen3BackPalettes", "kGen3BackDeflate", "kGen3BackDeflateOffsets",
        BACK_W, BACK_H,
        back_palettes, back_blobs,
        f"Gen3BackIcons — {BACK_W}x{BACK_H} 4-color Gen-3 (Emerald/FRLG) back sprites")
