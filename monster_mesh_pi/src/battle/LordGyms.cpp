...
// NG+ scaling stubs: lordScaleLevel returns baseLevel unchanged (no NG+ on Pi v1),
// lordCurrentNgPlusTier returns 0, lordApplyNgPlusMoves is a no-op.
...
{
    uint8_t lvl = lordScaleLevel(src.level, lordCurrentNgPlusTier(), /*isE4=*/false);
